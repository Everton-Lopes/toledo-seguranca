    ...
    <div className="site">
      ...
      <main id="main-content">
        ...
        <section id="trabalhe" className="career section-light section-fade" aria-labelledby="trabalhe-title">
          <div className="section-wrap career-inner">
            ...
            <form className="career-form reveal" onSubmit={handleCareer} onChange={() => { if (careerSent) setCareerSent(false) }}>
              ...
              <label className="consent">
                ...
                <span>Autorizo o uso dos dados pessoais e do currículo enviados exclusivamente para fins de recrutamento e seleção, podendo solicitar a exclusão a qualquer momento. <a href="/politica-de-privacidade.html" target="_blank" rel="noreferrer">Ver Política de Privacidade</a>.</span>
              </label>
              ...
              <button className="btn btn-dark" type="submit" disabled={careerSent}><WhatsAppIcon size={18} aria-hidden="true" /> {careerSent ? 'Dados validados' : 'Enviar candidatura'} <ArrowRight size={18} /></button>
              {careerSent && (
        ...
        <section id="orcamento" className="quote section-dark section-fade" aria-labelledby="orcamento-title">
          <div className="section-wrap quote-inner">
            ...
            <form className="quote-form reveal" onSubmit={handleQuote} onChange={() => { if (quoteSent) setQuoteSent(false) }}>
              <div className="form-row">
              ...
              <label className="consent">
                <input type="checkbox" required />
                <span>Autorizo o uso dos dados pessoais enviados exclusivamente para fins de orçamento e contato, podendo solicitar a exclusão a qualquer momento. <a href="/politica-de-privacidade.html" target="_blank" rel="noreferrer">Ver Política de Privacidade</a>.</span>
              </label>
              <button className="btn btn-gold" type="submit" disabled={quoteSent}><WhatsAppIcon size={18} aria-hidden="true" /> Enviar pelo WhatsApp</button>
      ...
      <footer className="footer">
        <div className="footer-main">
          ...
          >
            <img src="/assets/brand/toledo-logo.png" alt="Toledo Segurança" width="1377" height="950" loading="lazy" decoding="async" />
          </a>
          <div>
